...
>
  ...
  <p className="text-sm opacity-70">{props.repo.description}</p>
        ...
        <div className="flex items-center gap-1">
          <div
              className={cn(
                  ...
                  `language-project-${props.repo.language.toLowerCase()}`,
              )}
          ></div>
          <span className="opacity-70">{props.repo.language}</span>
        </div>
    )}
    <div className="flex items-center gap-1">
      <svg
      ...
      <span className="opacity-70">{props.repo.stargazers_count}</span>
    </div>
  </div>
</a>
