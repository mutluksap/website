  ...
  return (
    <div className='container mx-auto'>
        ...
        <p className="text-[15px] lg:text-lg text-gray-400 py-4">Welcome to my website. On my website, I will tell you about myself and my work. And I love listening to music. I leave a space at the bottom for you to send me your favorite music.
            <br/><br/>
            Now, I'm working for <a className='underline' href="https://www.next4biz.com/" target="_blank" rel="noreferrer" >next4biz</a> on various projects. In my current position, I am developing React, React building architectures and websites. Also as a freelancer, I try to make new initiatives by establishing websites and doing SEO studies.
        </p>
